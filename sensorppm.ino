...
float           No2Curve[2]     =  {45.34696335, 1.743219536};   //MQ135
...
void setup()
{
 ...
 // pinMode(13,OUTPUT);
  ...
  Serial.print("This will take approx 30 seconds ");                                     //prints "this will take approx "
...
void loop()
{
   ...
   //Serial.print("MQ135  :"); 
   Serial.print("Carbon di-oxide:"); 
   Serial.print(MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_CO2 ) );
  
   Serial.print( "ppm" );
   Serial.print("    ");   
   Serial.print("Nitrogen di-oxide:"); 
...
int MQGetGasPercentage(float rs_ro_ratio, int gas_id)
{
    ...
    if ( gas_id == GAS_CO2 ) {
     return MQGetPercentage(rs_ro_ratio,CO2Curve);     //MQ135
    } else if ( gas_id == GAS_No2 ) {
     return MQGetPercentage(rs_ro_ratio,No2Curve);     //MQ135
    } else if ( gas_id == GAS_CO ) {
     return MQGetPercentage(rs_ro_ratio,CO_secCurve);  //MQ135
    }
